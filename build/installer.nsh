...
!ifndef MINERADIO_INSTALL_TITLE
  !define MINERADIO_INSTALL_TITLE "Mineradio Setup"
!endif
...
If this PC only has C:, setup will automatically allow C:\Mineradio."
  ...
  ${AndIf} $1 != "\${MINERADIO_INSTALL_DIR_NAME_LOWER}"
    MessageBox MB_ICONSTOP|MB_OK "The install folder must be a dedicated Mineradio folder. Pick a parent folder and setup will create the Mineradio subfolder automatically."
    Abort
  ${EndIf}
...
Function MineradioWelcomeShow
  ...
  ${NSD_CreateLabel} 22u 96u 238u 24u "Install ${PRODUCT_NAME} for this computer. Default location is D:\${MINERADIO_INSTALL_DIR_NAME} — you can pick a different one on the next step."
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioBodyFont 1
  SetCtlColors $0 "4B5263" "FFFFFF"

  ${NSD_CreateLabel} 22u 130u 238u 12u "Default location: $INSTDIR"
  Pop $0
...
Function MineradioDirectoryBrowse
  nsDialogs::SelectFolderDialog "Select ${PRODUCT_NAME} install folder" "$INSTDIR"
  Pop $0
  ${If} $0 != error
  ${AndIf} $0 != ""
    Push "$0"
...
Function MineradioDirectoryShow
  ...
  ${NSD_CreateLabel} 22u 12u 238u 20u "Choose Install Location"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioTitleFont 1
  SetCtlColors $0 "111217" "FFFFFF"

  ${NSD_CreateLabel} 22u 40u 238u 24u "Use the default path, or pick another disk/folder. Missing directories are created automatically."
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioBodyFont 1
  SetCtlColors $0 "4B5263" "FFFFFF"

  ${NSD_CreateLabel} 22u 76u 238u 10u "Install directory"
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioSmallFont 1
  SetCtlColors $0 "3257F7" "FFFFFF"
  ...
  ${NSD_CreateBrowseButton} 210u 93u 50u 17u "Browse..."
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioSmallFont 1
  ${NSD_OnClick} $0 MineradioDirectoryBrowse

  ${NSD_CreateLabel} 22u 122u 238u 12u "Recommended default: D:\${MINERADIO_INSTALL_DIR_NAME} — picking a drive letter auto-creates the folder."
  Pop $0
  SendMessage $0 ${WM_SETFONT} $MineradioSmallFont 1
...
Function MineradioDirectoryLeave
  ...
  ${If} $0 == ""
    MessageBox MB_ICONEXCLAMATION|MB_OK "Please select an installation folder."
    Abort
  ${EndIf}
  Push "$0"
  Call MineradioNormalizeInstallDir
